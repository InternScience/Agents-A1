...
def main():
    ...
    parser.add_argument(
        "--input-file",
        default=settings.input_file if hasattr(settings, 'input_file') else "../../datasets/data/ifbench/IFBench_test.jsonl",
    ...
    print(f"\nRun evaluation with:")
    print(f"  python -m run_eval --input_data={args.input_file} --input_response_data={args.output_file} --output_dir=outputs/eval")
